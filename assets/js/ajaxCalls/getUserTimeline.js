    ...
    '<input class="postId" name="postId" type="hidden" value="'+post._id+'" />'+
        '<div class="timeline-container-status">'+
            ...
            if (hasLiked == false){
                ...
                '</button>';
                if(post.commentCount > 1){
                    tutorListing += '<a href="/post/<%=timeline[x].id%>" class="addComment">'+post.commentCount+' Comments</a>';
                }
                else if(post.commentCount === 1){
                    tutorListing += '<a href="/post/<%=timeline[x].id%>" class="addComment">'+post.commentCount+' Comment</a>';
                }else{
                    tutorListing += '<a href="/post/<%=timeline[x].id%>" class="addComment">Add Comment</a>';
                }
            }else{
                tutorListing +=
    ...
    '<div class="timeline-container-status">'+
        ...
        if (hasLiked == false){
            ...
            '<button class="like-button">'+
                ...
                '</svg></button>';
                if(post.commentCount > 1){
                    studyGroup += '<a href="/post/<%=timeline[x].id%>" class="addComment">'+post.commentCount+' Comments</a>';
                }
                else if(post.commentCount === 1){
                    studyGroup += '<a href="/post/<%=timeline[x].id%>" class="addComment">'+post.commentCount+' Comment</a>';
                }else{
                    studyGroup += '<a href="/post/<%=timeline[x].id%>" class="addComment">Add Comment</a>';
                }
         }else{
            studyGroup +=
            '<button class="like-button hasLiked">'+
